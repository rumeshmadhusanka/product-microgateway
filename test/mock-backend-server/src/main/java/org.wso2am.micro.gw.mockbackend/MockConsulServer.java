...
public class MockConsulServer extends Thread {
    ...
    private final String consulHttpApiPath = "/v1/health/service/";
    private final String testCaseLoadPath = "/tc/";


    public MockConsulServer(String host, int port, String scheme) {
        this.host = host;
        this.port = port;
        this.scheme = scheme;
    ...
    private void createContextsForHttpServer(HttpServer httpServer){
        String consulContext = consulHttpApiPath;
        ...
        String testCasesContext = testCaseLoadPath;
    ...
    public static void main(String[] args) {
        MockConsulServer consulServerHttp = new MockConsulServer("0.0.0.0", Constants.MOCK_CONSUL_SERVER_HTTPS_PORT, "https");
