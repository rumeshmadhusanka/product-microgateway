...
public class ConsulHttpsTestCase extends ConsulTestCase {
    ...
    public void consulLoadConfigToRouterTest() throws IOException, InterruptedException {
        ...
        HttpResponse tcResp = HttpClientRequest.doGet(mockConsulHttpsServerURL + testCaseContext + testCaseName, new HashMap<>());
